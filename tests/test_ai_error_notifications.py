...
def test_ai_error_notification_policy_reads_runtime_knobs(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(Config.ai, "ENABLE_FORWARD", True)
    monkeypatch.setattr(Config.ai, "FORWARD_URL", "https://open.feishu.cn/open-apis/bot/v2/hook/test")
    monkeypatch.setattr(Config.ai, "AI_ERROR_NOTIFICATION_COOLDOWN_SECONDS", 123)
    monkeypatch.setattr(Config.ai, "AI_ERROR_NOTIFICATION_TIMEOUT_SECONDS", 7)
