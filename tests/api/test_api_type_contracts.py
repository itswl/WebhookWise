...
def test_feishu_card_shows_ai_event_type_and_alert_identity():
    ...
    card = build_feishu_card(
        {
            ...
            "parsed_data": {
                ...
                "Resources": [
                    {
                        "ProjectName": "sample-cn",
                        "Region": "cn-shanghai",
                        "Name": "sample-cn-dev-gpu-node-01",
        ...
        },
        {
            ...
            "alert_identity": {
                ...
                "namespace": "VCM_ECS",
                "service": "GPU计算服务",
                "resource_name": "sample-cn-dev-gpu-node-01",
    ...
    # Identity is one breadcrumb line: location · service · resource(+id) · rule · metric.
    assert (
        "🏷️ sample-cn/cn-shanghai · GPU计算服务 · "
        "sample-cn-dev-gpu-node-01 i-yeb4gf629svr6ooeiadm · "
        "云服务器GPU卡告警 · GpuMemoryUsedUtilization" in rendered
    )
