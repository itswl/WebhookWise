...
def test_config_manager_no_longer_wraps_settings_sections() -> None:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("deep_analysis", "DEEP_ANALYSIS_POLL_INITIAL_DELAY_SECONDS", 121, "DEEP_ANALYSIS_POLL_INITIAL_DELAY_SECONDS"),
        ("deep_analysis", "DEEP_ANALYSIS_CONNECT_TIMEOUT_SECONDS", 901, "DEEP_ANALYSIS_CONNECT_TIMEOUT_SECONDS"),
