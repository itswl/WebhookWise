...
alert1 = {
    ...
    "alerts": [
        {
            ...
            "labels": {
                ...
                "host": "chat-service.internal.example",
    ...
    "alertingRuleName": "自定义 ns-region-a-prod-k8s Ingress-Nginx 请求时延过高",
}
...
print("\n告警1:")
print("  触发时间: 2026-01-13 04:47:04")
print("  告警ID: 69655cd8446159ccbb14307a")
print("  当前值: 3.39秒")
print(f"  哈希值: {hash1}")

print("\n告警2:")
print("  触发时间: 2026-01-13 07:42:04")
print("  告警ID: 696585dc33b1ddf9b92dd93e")
print("  当前值: 5.21秒")
print(f"  哈希值: {hash2}")
...
print("关键字段对比:")
print("=" * 100)
print("  alertingRuleName: ✓ 相同 - '自定义 ns-region-a-prod-k8s Ingress-Nginx 请求时延过高'")
print("  alertname: ✓ 相同 - '21083575-85b4-47c5-b65d-d48a986c974b'")
print("  host: ✓ 相同 - 'chat-service.internal.example'")
print("  path: ✓ 相同 - '/'")
print("  method: ✓ 相同 - 'POST'")
print("  fingerprint: ✓ 相同 - 'b15822399a03bce2'")
print("  alert_level: ✓ 相同 - 'P1'")
print("\n  internal_label_alert_id: ✗ 不同")
print("    告警1: 69655cd8446159ccbb14307a")
print("    告警2: 696585dc33b1ddf9b92dd93e")
print("  当前值: ✗ 不同 (3.39 vs 5.21)")
print("  触发时间: ✗ 不同 (04:47 vs 07:42)")
...
if hash1 == hash2:
    ...
    print("   这是同一个告警规则在同一资源上的持续触发")
    print("   虽然 alert_id 和当前值不同，但应该视为同一告警的不同时间点")
else:
    print("❌ 哈希值不同 - 被判定为不同告警（错误）")
    print(f"   告警1哈希: {hash1}")
    print(f"   告警2哈希: {hash2}")
    print("\n   问题: internal_label_alert_id 被包含在哈希计算中")
    print("   这导致同一规则、同一资源的持续告警被误判为不同告警")
