...
def _build_config_response(env_values: dict) -> dict:
    ...
    return {
        ...
        "duplicate_alert_time_window": _resolve_config_value(
            env_values, "DUPLICATE_ALERT_TIME_WINDOW", Config.DUPLICATE_ALERT_TIME_WINDOW, "int"
        ),
        ...
        "suppress_derived_alert_forward": _resolve_config_value(
            env_values, "SUPPRESS_DERIVED_ALERT_FORWARD", True, "bool"
        ),
    }
