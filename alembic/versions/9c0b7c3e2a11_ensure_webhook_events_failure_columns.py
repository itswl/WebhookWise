"""ensure webhook_events failure columns exist

Revision ID: 9c0b7c3e2a11
Revises: f3c2a1b4d0aa
...
revision: str = "9c0b7c3e2a11"
down_revision: str | Sequence[str] | None = "f3c2a1b4d0aa"
